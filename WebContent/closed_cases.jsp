...
<sql:query dataSource="${ds}"
	sql="select * from complaints where jurisdiction_station=? and comp_status='closed'"
	var="results">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<c:forEach var="complaint" items="${results.rows}" varStatus="row">
						...
						<c:if test="${row.first }">
							<c:out
								value="<div class='container' style='width:925px;' id='criminals_container'> <h1 class='text-center heading1'>Closed Cases</h1>"
...
<script type="text/javascript">
	...
	$('#closed').css('background-color', '#fb2');
</script>
