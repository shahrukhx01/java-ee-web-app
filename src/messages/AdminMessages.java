...
/**
 * Servlet implementation class AdminMessages
 */
...
public class AdminMessages extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		message = null;
		messageDetail = null;
		String subject,status, cont_message;
		...
		try {
			...
			if (cont_message.length()>0) {
				...
				String sql = "INSERT INTO `admin_messages`( `subject`, `msg`, `user_id`,`date`,`status`) VALUES (?,?,?,?,?) ";
