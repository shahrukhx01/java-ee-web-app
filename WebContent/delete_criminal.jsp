...
<c:forEach var="criminal" items="${results.rows}" varStatus="row">
	...
	<c:if test="${row.first }">
		...
		<c:out
			value="<div style='margin-top: 40px;' class='container' id='criminals_container'> <h1 class='text-center heading1'>Most Wanted Criminals</h1>"
				...
				<div class="col-xs-12 col-sm-12 emphasis">
					...
					<a
						...
						<button class="btn btn-primary btn-block">
							<span class="fa fa-times"></span> Delete Criminal
						</button>
					</a>
				</div>
			</div>
...
<script type="text/javascript">
	$('#criminals_container').css('width', '860px');
	...
	$('#delcrim').css('background-color', '#fb2');
