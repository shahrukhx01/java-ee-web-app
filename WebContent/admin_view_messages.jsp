...
<sql:query dataSource="${ds}"
	sql="select distinct subject FROM `admin_messages` JOIN `users` ON `admin_messages`.user_id=`users`.user_id "
	var="results">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Admin Messages</h4>
			</div>
													...
													<c:forEach var="message" items="${results.rows}"
														...
														<c:if test="${not empty message }">
															...
															<a id="${message.subject}" href="#myModal1"
																...
																class="name"
																style="min-width: 120px; display: inline-block;"></span>
																<span class="msg_subjects"> ${message.subject}</span> <span
																class="pull-right">User </span></a>
								...
								<div class="chat-box-footer">
									<div class="input-group">
										<input id="msg" type="text" class="form-control"
											...
											<button class="btn btn-success" id="admin_send_btn" type="button">SEND</button>
										</span>
									</div>
								</div>
							</div>
