...
/**
 * Servlet implementation class AddEvidenceImage
 */
@MultipartConfig
@WebServlet("/AddEvidenceImage")
public class AddEvidenceImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String messageUrl = "/complaint_progress.jsp?id="+id+"#content";
		...
		if (extension.equals("jpg") || extension.equals("jpeg")
			...
			try {
				img_name="evidence" + id + "0" + img_id + "." + extension;
...
//				dispatchMessage.forward(request, response);
		...
		try {
			...
			String sql = " INSERT INTO `evidence_images`(`complaint_id`, `image_name`) VALUES (?,?)";
			...
			if (i == 1) {
				...
				messageDetail = "Evidence image successfull added!";
				request.setAttribute("success", "success");
				request.setAttribute("messageDetail", messageDetail);
				
				PrintWriter wr=response.getWriter();
				wr.println(messageDetail);
				response.sendRedirect(request.getContextPath()+messageUrl);
				//dispatchMessage.forward(request, response);
			} else {
