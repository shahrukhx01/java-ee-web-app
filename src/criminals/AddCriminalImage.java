 ...
 */
@MultipartConfig
@WebServlet("/AddCriminalImage")
public class AddCriminalImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (extension.equals("jpg") || extension.equals("jpeg")
			...
			try {
				img_name="criminal" + id + "0" + img_id + "." + extension;
...
//				dispatchMessage.forward(request, response);
		...
		try {
			...
			psmt.setString(3, "criminal");
			int i = psmt.executeUpdate();

			if (i == 1) {
				isRegistered = true;

				messageDetail = "Criminal's image successfull added!";
